...
function SignUp() {
    ...
    const signInGoogle = useGoogleLogin({
      onSuccess: codeResponse => {
        ...
        return dispatch(signUpActions.signup({token}));
      },
      onError: () => {
        ...
        <div className="w-full md:w-1/2">
          <div className="min-h-[100dvh] h-full flex flex-col after:flex-1">
            ...
            <div className="w-full max-w-sm px-4 py-8 mx-auto">
                ...
                <div className="space-y-4">
                   <!-- <div>
                    <label className="block mb-1 text-sm font-medium" for="email"
                      >Email Address <span className="text-rose-500">*</span></label
                    >
                    <input id="email" className="w-full form-input" type="email" />
                  </div> --> 
                  <div>
                    <label className="block mb-1 text-sm font-medium" htmlFor="name"
                      >Full Name <span className="text-rose-500">*</span></label
                    >
                    <input id="name" className="w-full form-input" type="text" name="name" {...register('name')}/>
                  </div>

                  <div>
                    <label className="block mb-1 text-sm font-medium" htmlFor="phone" 
                      >Phone <span className="text-rose-500">*</span></label
                    >
                    <input id="phone" className="w-full form-input" type="text" name="phone" {...register('phone')}/>
                  </div>
                  ...
                  <button disabled={isSubmitting} className="ml-3 text-white bg-indigo-500 btn hover:bg-indigo-600 whitespace-nowrap">
              ...
              >
              <svg className="w-4 h-4 mr-2 -ml-1" stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
